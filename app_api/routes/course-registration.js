...
const entryCtrl = require('../controllers/course-registration')(opt);

router.get('/entries' , 

						cUser.roleType([...opt.normalPrivilege , 'staff' , ...opt.superPrivilege]) ,

						queryType.queryByUnit('Course Registration' , ['Course Registration'] , opt.normalPrivilege , opt.superPrivilege , opt.second) ,

						searchQuery.finalRequestSearchQueryFilter ,

						searchQuery.searchByRequestType('Course Registration' , ['Course Registration'] , opt.normalPrivilege , opt.superPrivilege , opt.second , 'CR') ,

						searchQuery.searchByStatus('Course Registration' , ['Course Registration'] , opt.normalPrivilege , opt.superPrivilege , opt.second , 'CR') ,

						searchQuery.searchByAppNumber('Course Registration' , ['Course Registration'] , opt.normalPrivilege , opt.superPrivilege , opt.second , 'CR') ,
...
router
			.post('/create'	, 
						...
						queryType.setEntryType('CR' , 'Course Registration') ,
...
router
			...
			.get( cUser.roleType([...opt.normalPrivilege , 'staff' , ...opt.superPrivilege]) , 
						...
						cUser.userUnit(['Course Registration'] , [...opt.normalPrivilege , 'staff' , ...opt.superPrivilege] , true , ['staff']) ,

						general.entryDetail('Course Registration'))

			.put( cUser.roleType(['staff' , ...opt.superPrivilege]) , 

						cUser.userUnit(['Course Registration'] , ['staff' , ...opt.superPrivilege] , true , ['staff']) ,
...
router
			...
			.patch( cUser.roleType([...opt.superPrivilege , 'staff']) , 
						...
						general.entryDeleteMany('Course Registration'));
