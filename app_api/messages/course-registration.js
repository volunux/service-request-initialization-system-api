module.exports = {
	...
	'review' : (req , res , next) => {
			...
			return { 'message' : `Your application is currently under review. You will get a feedback or response within 3 working days and you can resend the request if you didn't get any response.
						...
						'title' : `Course Registration Application and Request Under Review` }
	} ,
	...
	'fulfilled' : (req , res , next) => {
			...
			return { 'message' : `Your application has been successful and you will be able to continue with your Course Registrations for the current academic session. Yes, you are free because it has been resolved.
						
						Thank you for using our services.` ,

						'title' : `Course Registration Request Successfully Resolved` }
	}
